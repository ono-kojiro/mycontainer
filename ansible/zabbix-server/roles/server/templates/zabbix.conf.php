...
$ZBX_SERVER_TLS['CA_FILE'] = '/etc/ssl/certs/ca-certificates.crt';
$ZBX_SERVER_TLS['KEY_FILE'] = '/etc/zabbix/certs/zabbix_server.key';
$ZBX_SERVER_TLS['CERT_FILE'] = '/etc/zabbix/certs/zabbix_server.crt';
